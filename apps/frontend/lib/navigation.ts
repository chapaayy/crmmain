...
export const menuItems: MenuItem[] = [
  ...
  { label: "Задачи сотрудников", href: "/employee-tasks", permission: "employee_tasks.read", icon: ClipboardCheck },
  { label: "Ответственности", href: "/responsibilities", permission: "responsibilities.read", icon: ListChecks },
  { label: "Доступы / Secrets", href: "/secrets", permission: "secrets.read_metadata", icon: KeyRound },
